		...
		<table width="600px" align="left">
			...
			<tr>
                ...
                <tr>
                    ...
                    <td align="left"><div class="form-group">
                    <label> Se requiere un tipo de lenguaje </label>
                ...
                <tr>
                    <td align="left"><div class="form-group">
                    <label> Se requiere un administrador para el repositorio </label>
                        <select name="administrador" id="administrador" class="form-control">
                                <option value ""> Escoja el administrador del repositorio </option>
