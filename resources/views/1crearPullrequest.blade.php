...
@section('content')
    ...
    <h1 class="title m-b-md" align="center">Insertar datos del Pull Request a crear</h1>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
						...
						<li><a href="{{action('WebController@pullrequestRepositorio', $valor)}}">VOLVER A LA PAGINA PRINCIPAL DE PULL REQUESTS</a></li>
	...
	{{ csrf_field() }}
		<table width="400px" align="left">
            ...
            <tr>
                <td> <input type="submit" value="Crear Pull Request"></td>
            </tr>
		</table>
	</form>
    </div>
